...
def _generate_captcha_image(text: str) -> str:
    """Generate a secure captcha image with distortion."""
...
def generate_captcha():
    ...
    # 5-character alphanumeric mixed case (exchuding ambiguous chars)
...
def verify_captcha():
    ...
    answer = sanitize_input(str(data.get("answer", ""))).strip()
